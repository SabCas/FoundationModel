var deckData = {
  ...
  'founder-thesis': ['The System Shift', 'The Coordination Bottleneck', 'Autonomous platforms are advancing quickly, but mission coordination has not kept pace. Carriers, drones, sensors, maps, and operator workflows often remain disconnected.', 'Investor bridge / problem'],
  ...
  'signal-control-fragility': ['Why This Matters', 'Disconnected Systems', 'Assets, sensors, maps, and command tools do not automatically share one operational context.', 'Problem / system fragmentation'],
