var deckData = {
  ...
  'product-local-drone-teams': ['Our Products', 'Local Drone Agents', 'Deployable drones sense, localize, map, and report local mission context near the objective.', 'Product direction'],
  'product-mission-software': ['Our Products', 'Mission Software Stack', 'Connects carrier agent, local drone agents, mission data, and human supervision into one shared operational picture.', 'Product direction'],
