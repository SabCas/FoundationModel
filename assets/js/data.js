var deckData = {
  ...
  'founder-thesis': ['The System Shift', 'The Bottleneck', 'Autonomous assets are still fragmented: carriers, drones, maps, feeds, and operators remain split across tools. The bottleneck is coordination, not another airframe.', 'Investor bridge / problem'],
  'company-vision': ['The System Shift', 'The Mission Layer', 'KUBECA connects reach, local sensing, mission software, and human supervision into one shared mission picture. The system coordinates assets while operators stay in command.', 'Investor bridge / system'],
  ...
  'built-from-field-experience': ['The System Shift', 'The First Configuration', 'Phase 1 proves the aerial configuration: carrier platform, local drone agents, mission intelligence, and supervised handover. The same layer is designed to expand toward future ground, maritime, and sensor assets.', 'Investor bridge / validation'],
  'signal-control-fragility': ['Why This Matters', 'Limited Reach', 'Small drones create valuable local intelligence, but lose endurance, payload, and connectivity far from the operator.', 'Problem / range limit'],
  'human-bottleneck': ['Why This Matters', 'Fragmented Control', 'Carrier systems, drone feeds, maps, telemetry, and decisions often remain separated across tools, increasing operator workload.', 'Problem / disconnected workflow'],
  'mission-data-overload': ['Why This Matters', 'Broken Continuity', 'Terrain, buildings, RF disruption, and degraded infrastructure can break the mission picture between assets and operators.', 'Problem / mission continuity'],
