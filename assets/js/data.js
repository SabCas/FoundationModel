var deckData = {
  ...
  'market-deep-recon': ['Where KUBECA Creates Value', 'Defense / Tactical ISR', 'Long-range reconnaissance, distributed drone teams, and supervised situational awareness in contested and high-risk environments.', 'Initial focus'],
  'market-indoor-urban': ['Where KUBECA Creates Value', 'Search & Rescue / Disaster Response', 'Rapid assessment of damaged areas, local mapping, survivor-search support, and access to locations unsafe for responders.', 'Expansion market'],
  'market-distributed-isr': ['Where KUBECA Creates Value', 'Critical Infrastructure Security', 'Inspection and perimeter awareness across energy facilities, transport hubs, borders, ports, and industrial sites.', 'Expansion market'],
  'market-infrastructure': ['Where KUBECA Creates Value', 'Public Safety / Urban Operations', 'Indoor mapping, complex-site awareness, and supervised local sensing in dense or hard-to-access urban environments.', 'Expansion market'],
