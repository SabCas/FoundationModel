var deckData = {
  ...
  'built-from-field-experience': ['The System Shift', 'The First Configuration', 'The first proof point is aerial: carrier platform, local drone agents, mission intelligence, and supervised handover. The same layer is designed to expand toward future autonomous assets across domains.', 'Investor bridge / validation'],
  ...
  'product-carrier-platform': ['Our Products', 'Carrier Platform', 'A standardized carrier platform extends mission range, maintains relay connectivity, and carries mission-specific modules for deployment, sensing, or communication.', 'The reach layer'],
  ...
  'product-local-drone-teams': ['Our Products', 'Local Drone Teams', 'Deployable local drone teams start with FPV and assisted operation for close-area sensing, then progress toward autonomous scout behavior as the system matures.', 'The close-area intelligence layer'],
  ...
  'investor-roadmap': ['Investor Roadmap', 'Capital Staged Around Risk Reduction', 'Indicative capital stages aligned to hardware validation, repeatable pilot systems, and a verification pathway toward regulated scale.', 'Indicative financing plan'],
  'current-investment-focus': ['Current Investment Focus', 'Pre-Seed / Prototype Round', 'KUBECA is preparing an indicative \u20ac2-4M round to validate the carrier-enabled mission system in hardware and prepare pilot-production readiness.', 'Indicative current round'],
