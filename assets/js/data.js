var deckData = {
  ...
  'enable-reach': ['What It Enables', 'Reach', 'Local intelligence beyond normal drone range.', 'Operational outcome'],
  'enable-shared-awareness': ['What It Enables', 'Shared Awareness', 'One operational picture instead of isolated feeds.', 'Operational outcome'],
  'enable-reduced-workload': ['What It Enables', 'Reduced Workload', 'The system structures information before it reaches the operator.', 'Operational outcome'],
  'enable-safer-standoff': ['What It Enables', 'Safer Standoff', 'Teams can understand an area before entering it.', 'Operational outcome'],
  'enable-faster-decisions': ['What It Enables', 'Faster Decisions', 'Operators receive context, not just raw data.', 'Operational outcome'],
  'market-deep-recon': ['Where KUBECA Creates Value', 'Deep Reconnaissance', 'Small teams need local intelligence from areas they cannot safely approach or reach with short-range drones. KUBECA extends reach, deploys local drone teams, maintains relay connectivity, and returns structured spatial updates.', 'More standoff. Less exposure. Better local understanding.'],
  'market-indoor-urban': ['Where KUBECA Creates Value', 'Indoor / Urban Mapping', 'Urban, enclosed, and GPS-denied environments break conventional remote-control workflows. KUBECA enables local drones to build spatial context: rooms, corridors, paths, obstacles, entrances, changes, and risk areas.', 'Maps and context, not only video.'],
  'market-distributed-isr': ['Where KUBECA Creates Value', 'Distributed ISR', 'Multiple aerial assets should not remain isolated video feeds. KUBECA coordinates carrier platforms, local drones, shared spatial data, and operator control into one intelligence loop.', 'One mission picture instead of fragmented sensing.'],
  'market-infrastructure': ['Where KUBECA Creates Value', 'Infrastructure / Perimeter Intelligence', 'Critical infrastructure and perimeter missions need persistent awareness, local inspection, and human-supervised autonomy across complex sites.', 'Persistent spatial awareness across complex sites.'],
  'validation-platform-development': ['Field Validation', 'Platform Development', 'Drone systems developed from concept to flight.', 'Proof block'],
  'validation-gps-denied': ['Field Validation', 'GPS-Denied Software Testing', 'Autonomy software tested under constrained positioning and control conditions.', 'Proof block'],
  'validation-fixed-wing': ['Field Validation', 'Autonomous Fixed-Wing Flight', 'Early fixed-wing autonomy experience supports the carrier-platform direction.', 'Proof block'],
  'validation-spatial-understanding': ['Field Validation', 'Spatial Understanding', 'Early scene-graph based environment understanding has been implemented and flight-tested.', 'Proof block'],
  'validation-operator-feedback': ['Field Validation', 'Operator Feedback', 'Product judgment shaped by reliability, degraded infrastructure, operator workload, mission continuity, and field iteration.', 'Proof block'],
  'roadmap-foundation': ['Roadmap', 'Foundation Validated', 'Quadcopter development, GPS-denied testing, early spatial understanding, and first autonomous fixed-wing flight.', 'Milestone'],
  'roadmap-carrier-platform': ['Roadmap', 'Carrier Platform', 'Composite fixed-wing carrier, payload integration, relay architecture, and field-test iteration.', 'Milestone'],
  'roadmap-local-drone-teams': ['Roadmap', 'Local Drone Teams', 'Autonomous stabilization, local mapping, exploration, and spatial context generation.', 'Milestone'],
  'roadmap-controlled-deployment': ['Roadmap', 'Controlled Deployment', 'Carrier-based release, clean separation, stabilization, and communication handover.', 'Milestone'],
  'roadmap-integrated-demo': ['Roadmap', 'Integrated System Demo', 'Carrier flight, local drone deployment, spatial intelligence, and operator handover.', 'Milestone'],
  ...
  'request-mission-brief': ['CTA', 'Request Investor Access', 'Request a focused investor briefing to review the KUBECA system architecture, operational use cases, and validation roadmap.', 'Primary action'],
  'contact-kubeca': ['CTA', 'Contact The Team', 'Connect with KUBECA to discuss strategic partnerships, operator feedback, investment conversations, and mission demonstrations.', 'Secondary action'],
