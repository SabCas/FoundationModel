var deckData = {
  ...
  'pitch-system': ['What We Build', 'The KUBECA System', 'Seed product: aerial carrier-swarm operations. KUBECA connects aerial carriers, local quadcopters, mission context, and human supervision into one coordinated system.', 'Main pitch / system'],
  'pitch-progress': ['How We Advance', 'Current Progress', 'KUBECA has completed carrier CAD, is building the prototype chassis, demonstrated first autonomous carrier flight, and started GNSS-denied integration.', 'Main pitch / progress'],
  ...
  'founder-thesis': ['The System Shift', 'The Coordination Bottleneck', 'Autonomous platforms are advancing quickly, but mission coordination has not kept pace. Assets, sensors, maps, and operator workflows remain disconnected.', 'Investor bridge / problem'],
  'company-vision': ['The System Shift', 'The KUBECA System', 'KUBECA connects carrier platforms, autonomous sub-agents, mission software, and human supervision into one coordinated system.', 'Investor bridge / system'],
  ...
  'built-from-field-experience': ['The System Shift', 'Phase 1 Carrier-Swarm MVP', 'Phase 1 validates a deployable configuration: GNSS-resilient carrier transport and release, GNSS-denied local operation, and mission-software relay, supervision, and handover across the operation.', 'Investor bridge / validation'],
  'signal-control-fragility': ['Why This Matters', 'Disconnected Systems', 'Drones, ground robots, maritime carriers, sensors, maps, and command tools do not share one operational context.', 'Problem / system coordination'],
  'human-bottleneck': ['Why This Matters', 'Degraded Continuity', 'GNSS denial, communication loss, terrain, structures, and defensive pressure can fragment the mission.', 'Problem / mission continuity'],
  'mission-data-overload': ['Why This Matters', 'Operator Overload', 'Operators must interpret multiple feeds and tools instead of supervising one coherent mission system.', 'Problem / operator workload'],
  'infrastructure-less-reliable': ['Why Now', 'Infrastructure Is Less Reliable', 'GNSS, RF, terrain, buildings, and electronic warfare increasingly degrade mission continuity. Autonomous systems need resilient navigation and shared awareness that continue working when infrastructure fails.', 'Timing driver'],
  ...
  'carrier-relay-layer': ['What We Build', 'Carrier / Relay', 'GNSS-resilient carrier extends reach, transports local quadcopters, and maintains relay/control workflow.', 'System layer'],
  'local-autonomous-drone-teams': ['What We Build', 'Local Drone Teams', 'Released GNSS-denied quadcopters continue local sensing, mapping, or FPV-assisted operation near the mission area.', 'System layer'],
  ...
  'operator-control-interface': ['What We Build', 'Mission Software + Operator', 'Mission software connects asset state, feeds, maps, and human supervision into one shared mission picture.', 'System layer'],
  'product-carrier-platform': ['Our Products', 'Carrier Platform', 'A standardized GNSS-resilient carrier platform extends mission range, maintains relay connectivity, and carries mission modules for local quadcopter release, sensing, or communication.', 'The GNSS-resilient reach and relay layer'],
  'product-mission-modules': ['Our Products', 'Mission Modules', 'Mission capability changes through interchangeable modules such as relay, sensing, deployment, or hybrid payloads.', 'The configurable mission layer'],
  'product-local-drone-teams': ['Our Products', 'Local Drone Teams', 'Released local quadcopters begin with FPV, assisted sensing, and GNSS-denied local operation near the objective, then progress toward autonomous scout behavior as the system matures.', 'The GNSS-denied local operation layer'],
  'product-mission-software': ['Our Products', 'Mission Software', 'Mission software converts carrier state, local drone feeds, maps, telemetry, and operator decisions into one supervised mission picture.', 'The coordination layer'],
  'market-deep-recon': ['Where KUBECA Creates Value', 'Beachhead: Defense / Tactical ISR', 'Carrier reach, local sensing, relay support, and supervised situational awareness in GNSS-denied or high-risk environments.', 'Initial focus'],
  'market-indoor-urban': ['Where KUBECA Creates Value', 'Adjacent Markets', 'Disaster response, search operations, infrastructure security, border monitoring, maritime inspection, and ground robotics share the same coordination problem.', 'Adjacent application'],
  'market-distributed-isr': ['Where KUBECA Creates Value', 'Platform Expansion', 'The long-term opportunity is not one drone category - it is the mission layer coordinating autonomous assets across air, ground, maritime systems, sensors, and operators.', 'Platform expansion'],
  'validation-real-system-development': ['Field Validation', 'Built From Real Autonomous System Development', 'Prior team experience in systems development, autonomy software, field testing, operator feedback, and defense-relevant environments informs the KUBECA architecture and staged validation path.', 'Verified team track record'],
  'investor-roadmap': ['Capital Staged Around Risk Reduction', 'Seed Round: Prove the Mission Layer', 'KUBECA is preparing an indicative \u20ac5-8M Pre-Seed / Integrated Prototype round with 18-24 months runway to validate carrier reach, reliable quadcopter release, GNSS-denied local operation, relay/control workflow, and flight-tested carrier-to-quadcopter mission handover.', 'Indicative financing plan'],
  ...
  'drone-scale-accelerating': ['Why Now', 'Coordinated Systems Shift', 'The next autonomy wave is coordinated systems, not isolated vehicles. Autonomous assets are moving from single platforms to connected air, ground, and maritime systems.', 'Timing driver'],
  'signals-no-longer-trusted': ['Why Now', 'Signals Can No Longer Be Trusted', 'GNSS disruption, RF interference, terrain, buildings, and electronic warfare are breaking traditional control links and degrading mission continuity.', 'Timing driver'],
  ...
  'autonomous-systems-shift': ['Why Now', 'KUBECA Entry Point', 'KUBECA validates the mission layer through aerial carrier-swarm operations, then extends the same coordination model across domains.', 'Technology shift'],
  ...
  'early-investors': ['Who We Work With', 'Early-stage investors', 'KUBECA is positioned for early strategic conversations around resilient autonomy and GNSS-denied navigation.', 'Investor access']
};
...
var detailData = {
  ...
  'prototype-platforms': {
    ...
    intro: 'Modular aerial platforms designed to operate independently or as an integrated team in GNSS-denied environments.',
    body: '',
    bullets: [],
    why: ''
  }
