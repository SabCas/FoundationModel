var deckData = {
  ...
  'pitch-system': ['What We Build', 'The KUBECA System', 'KUBECA connects carrier platforms, local drone agents, mission software, and human supervision into one shared mission picture.', 'Main pitch / system'],
  ...
  'founder-thesis': ['The System Shift', 'The Coordination Bottleneck', 'Autonomous platforms are advancing quickly, but mission coordination has not kept pace. Carrier hardware, local assets, sensors, maps, relay links, and operator workflows still have to become one mission system.', 'Investor bridge / problem'],
  'company-vision': ['The System Shift', 'The Mission-Intelligence Layer', 'KUBECA connects reach, local sensing, mission software, and human supervision into one shared mission picture. Operators stay in command while the system coordinates the mission.', 'Investor bridge / system'],
  ...
  'built-from-field-experience': ['The System Shift', 'The First Configuration', 'The first proof point is an integrated aerial handover: GNSS-resilient carrier platform, GNSS-denied local quadcopters, mission intelligence, and supervised operator workflow. The same layer is designed to expand toward future autonomous assets across domains.', 'Investor bridge / validation'],
  'signal-control-fragility': ['Why This Matters', 'Reach + Deployment Gap', 'Local assets need reach, relay, payload capacity, and deployment support before they can create useful intelligence far from the operator.', 'Problem / reach and deployment'],
  'human-bottleneck': ['Why This Matters', 'Degraded Continuity', 'Range limits, terrain, structures, and communication disruption can break the mission picture.', 'Problem / mission continuity'],
  ...
  'market-deep-recon': ['Where KUBECA Creates Value', 'Defense / Tactical ISR', 'Reach, persistence, and local intelligence in high-risk or hard-to-access environments through carrier-enabled deployment, local drone teams, relay support, and one supervised mission picture.', 'Initial focus'],
  'market-indoor-urban': ['Where KUBECA Creates Value', 'Disaster Response / Search Operations', 'Rapid understanding of damaged, dangerous, or inaccessible areas through local sensing, relevant area mapping, and one shared operational picture.', 'Adjacent application'],
  'market-distributed-isr': ['Where KUBECA Creates Value', 'Critical Infrastructure Security', 'Coordinated sensing across large, complex, or vulnerable sites through carrier systems, local agents, and mission-level supervision.', 'Platform expansion'],
