...
function initializeProductsDeck() {
  if (!detailGrid) return;

  var deck = detailGrid.querySelector('[data-products-deck]');
  if (!deck) return;

  var panels = Array.prototype.slice.call(deck.querySelectorAll('[data-product-panel]'));
  var tabs = Array.prototype.slice.call(deck.querySelectorAll('[data-product-tab]'));

  function showProduct(index, shouldFocus) {
